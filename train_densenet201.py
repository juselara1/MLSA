...
augmentation = {"preprocessing_function": tf.keras.applications.densenet.preprocess_input, "apply":True,
...
augmentation = {"preprocessing_function": tf.keras.applications.densenet.preprocess_input, "apply":False}
val_seq = ImageAugmentationSequenceH5("/tf/TCGA/images.h5", "ims_val", "y_val", num_classes=2,
                                        labels_transform=lambda i:np.int32(i>1),
                                        class_weighted=False, categorical=True, batch_size=8,
...
callback = tf.keras.callbacks.ModelCheckpoint("densenet201.h5")
