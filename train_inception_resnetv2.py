...
augmentation = {"preprocessing_function": tf.keras.applications.inception_resnet_v2.preprocess_input, "apply":True,
...
augmentation = {"preprocessing_function": tf.keras.applications.inception_resnet_v2.preprocess_input, "apply":False}
...
callback = tf.keras.callbacks.ModelCheckpoint("InceptionResNetV2.h5")
