...
augmentation = {"preprocessing_function": tf.keras.applications.resnet_v2.preprocess_input, "apply":True,
...
augmentation = {"preprocessing_function": tf.keras.applications.resnet_v2.preprocess_input, "apply":False}
...
callback = tf.keras.callbacks.ModelCheckpoint("resnet152v2.h5")
